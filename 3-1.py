...
#    This creates one layer of a neural net with 3 neurons
    input = X
    hidden = tf.layers.dense(inputs=input, units=3)
...
#        the variables
        ...
        #numBatches = int(train_y.shape[0]/batch_size)
